...
def ensure_tables_loaded():
    ...
    if len(omor2ftb3) == 0:
        ...
        for stuff, omor in Ftb3Formatter.stuff2omor.items():
            omor2ftb3[omor] = Ftb3Formatter.stuff2ftb3[stuff]
...
def main():
    ap = argparse.ArgumentParser(
        description="Convert between tag formats of Omorfi with omor as pivot")
