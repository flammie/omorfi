...
def main():
    """Command-line interface for lexc generations."""
    # defaults
    curr_lexicon = dict()
    # initialise argument parser
    ap = argparse.ArgumentParser(
        description="Convert Finnish dictionary TSV data " +
        "into xerox/HFST lexc format")
    ...
    ap.add_argument("--continuations", "-c", action="append", required=True,
                    dest='contfilenames',
                    metavar="CONTFILE",
                    help="read continuations from CONTFILEs")
    ...
    ap.add_argument("--format", "-f", action="store", default="omor",
                    ...
                    choices=["omor", "giella", "ftb3", "ftb1", "none",
                             "apertium", "labelsegments"])
