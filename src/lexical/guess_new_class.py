        ...
        if tn == 1:
            ...
            if not wordmap['kotus_av']:
                ...
                if wordmap['stem_vowel'] == 'a':
                    ...
                    wordmap['new_paras'] = ['N_VERSAILLES']
