...
| [EY](lexemes/EY.html) | **or**  Euroopan Yhteisö |
...
| [jos](lexemes/jos.html) | **or**  if, as sconj, "jos voisit jäädä", see VISK § 818 |
...
| [öisin](lexemes/öisin.html) |  usually seen as adverb (nightly), but can be analysed as a form of *yö* (night), *öinen* (nightly) <!-- vim: set ft=markdown:-->
